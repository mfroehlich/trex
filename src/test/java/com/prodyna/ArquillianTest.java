...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "trex";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "trex.war")
            ...
            .addPackages(false, "com.prodyna") // not recursive to skip package 'nonarquillian'
